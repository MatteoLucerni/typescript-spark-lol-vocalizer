...
import {
  ...
  import { getTeamBySummonerName, delay, formatTime } from './utils';
  ...
  export class BackgroundController {
    ...
    private handleDragonKill(gameEvent: any) {
      ...
      console.log(`Drago ucciso al minuto ${formatTime(this.lastDragonKillTime)}. Prossimo respawn al minuto ${formatTime(this.nextDragonSpawnTime)}.`);
